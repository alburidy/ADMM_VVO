...
%--------------------------
SD.oltc_l=[1 2;43 44;42 54];        % Enter LTCs locations
SD.cb_l=[8;48;90;112];              % Enter SCBs locations
%--------------------------
Qc_max=[1200;1200;600;600];  % Enter Qc max. capacity in kVARs
SD.Cstp = 0.03;              % Enter Qc incremental step change value.
SD.Cinr = [4;4;2;2];         % Enter max. integer number for bsh
%--------------------------
